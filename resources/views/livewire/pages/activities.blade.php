                ...
                <div class="rounded-xl overflow-hidden border border-outline-variant! dark:border-slate-800! shadow-sm hover:shadow-lg transition-shadow duration-300 bg-surface-container-low dark:bg-surface-container-high">
                    ...
                    <div class="p-6 bg-surface dark:bg-surface-container">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pt-4 border-t border-outline-variant dark:border-slate-800">
                            <span class="text-lg font-headline font-bold text-primary">{{ $event->price > 0 ? 'KES ' . number_format($event->price, 2) : 'Free' }}</span>
                            <div class="flex flex-wrap gap-3">
                                <a href="tel:+254757151520" class="inline-flex items-center justify-center px-2 py-2 rounded-full bg-primary text-on-primary hover:bg-primary-fixed-dim font-semibold transition-colors"><i class="material-symbols-outlined ">phone</i></a>
                                <a href="sms:+254757151520?body=I%27m%20interested%20in%20booking%20{{ urlencode($event->name) }}" class="inline-flex items-center justify-center px-2 py-2 rounded-full bg-surface-container-high text-on-surface hover:bg-surface-container-low transition-colors"><i class="material-symbols-outlined ">message</i></a>
                                <a href="https://wa.me/+254757151520?text={{ urlencode('Hi, I am interested in booking ' . $event->name) }}" target="_blank" rel="noopener noreferrer" class="rounded-full bg-green-400 hover:bg-green-100 inline-flex items-center justify-center px-2 py-2 transition-colors"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
